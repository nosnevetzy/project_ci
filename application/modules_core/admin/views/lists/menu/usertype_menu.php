				...
				<tr>
					...
					<td>
						<div class="controls center">
							<!-- Access Links -->
							<?php
							if($this->Misc->accessible($this->access,'menu','page','view_menu')){ ?>
							<a href="<?php echo admin_url('menu/view_menu_page/'.$this->Misc->encode_id($q->id_user_type)); ?>" title="View Menu List" class="tip"><span class="icon16 icomoon-icon-search-3"></span></a>
							<?php
							} ?>
						</div>
					</td>
