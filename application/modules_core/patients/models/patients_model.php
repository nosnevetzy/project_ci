...
class Patients_Model extends MY_Model {
    ...
    function getFields($id) {
        ...
        self::_join();
        self::_fix_arg();
        parent::where(array('p.id_patient' => $id));
        $query = $this->db->get();
    ...
    private function _fix_arg() {
        $this->db->where(array('p.enabled' => 1));
    }
    ...
    function insert_table($data) {
        $this->db->insert("opt_patients", $data);
    ...
    function insert_batch_table($data) {
        $this->db->insert_batch("opt_patients", $data);
    }
    ...
    function update_table($data, $where) {
        self::where($where);
        $this->db->update("opt_patients", $data);
    }
    ...
    function update_batch_table($data, $table_col) {
        $this->db->update_batch("opt_patients", $data, $table_col);
    }
    ...
    function delete_table($table_col, $key) {
        $this->db->delete("opt_patients", array($table_col => $key));
    }
