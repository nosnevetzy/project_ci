    ...
    <div class="modal-body">
        ...
        <form class="form-horizontal form-label-left" novalidate>
            <div class="item form-group">
                <div class="col-lg-12">
                    <textarea id="popformdata_iop"class="wysihtml5 wysihtml5-min form-control popformdata"><?php echo $row->iop ?> </textarea>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#popformdata_save').on('click', {
            'action': "<?php echo iop_url("page/method/edit_iop"); ?>",
            'item': "<?php echo $this->misc->encode_id($row->id_iop); ?>",
            'conMessage': "You are about to edit this IOP Measurement.",
            'clear': true,
