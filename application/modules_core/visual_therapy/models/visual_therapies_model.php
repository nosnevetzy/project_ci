...
class Visual_Therapies_Model extends MY_Model {
    ...
    function getFields($id) {
        ...
        self::_join();
        self::_fix_arg();
        parent::where(array('vt.id_visual_therapy' => $id));
        $query = $this->db->get();
    ...
    function getListPatient($id) {
        ...
        self::_join();
        self::_fix_arg();
        parent::where(array('vt.patient_id' => $id));
        $query = $this->db->get();
    ...
    function getListLimit($where = array(), $where_string = '', $order_by = array(), $page = 0, $number = 0) {
        ...
        // parent::group_by("vt.id_visual_therapy");
        parent::orderby($order_by);
    ...
    private function _from() {
        $this->db->from("opt_visual_therapies vt");
    }
    ...
    private function _fix_arg() {
        $this->db->where(array('vt.enabled' => 1));
    }
    ...
    function insert_table($data) {
        $this->db->insert("opt_visual_therapies", $data);
    ...
    function insert_batch_table($data) {
        $this->db->insert_batch("opt_visual_therapies", $data);
    }
    ...
    function update_table($data, $where) {
        self::where($where);
        $this->db->update("opt_visual_therapies", $data);
    }
    ...
    function update_batch_table($data, $table_col) {
        $this->db->update_batch("opt_visual_therapies", $data, $table_col);
    }
    ...
    function delete_table($table_col, $key) {
        $this->db->delete("opt_visual_therapies", array($table_col => $key));
    }
