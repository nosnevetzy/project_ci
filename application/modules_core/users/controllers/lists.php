...
class Lists extends System_Core {
    ...
    function users() {
        ...
        $this->load->view(users_dir('list_user'), $data);
    }
    ...
    function departments() {
        ...
        $this->load->view(users_dir('list_department'), $data);
    }
    ...
    function method() {
        ...
        } else if ($this->uri->rsegment(3) == 'list_department') { /* Method for User */
            self::_method_list_department();
        }
    }
    ...
    function _method_list_department() {
        if (!IS_AJAX) {
            // Set confirmation message
            $this->session->set_flashdata('error', 'Direct access forbidden');
            redirect(admin_url($this->classname));
        ...
        $details = array_merge($data, $this->Misc->get_pagination_data($datas)); //get pagination data
        $this->load->view(users_dir('list/department_list'), $details);
    }
